...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_9c15_8d73_7f7a_6257_b8a1_a863_21e9_a271',
  ...
  BRAINSHOP: process.env.BRAINSHOP || '176187,fpP88ip9qevEFyCz',
  TGTOKEN: "bot891038791:AAHWB1dQd-vi0IbH2NjKYUk-hqQ8rQuzPD4",
  API: 'https://api.lokiser.xyz/',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'TroubleMaker┃ᴮᴼᵀ;Vivek',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'TroubleMaker┃ᴮᴼᵀ;Vivek;919148942515;https://telegra.ph/file/238b8ea9aab7c77c30052.jpg',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '919148942515,918660885785',
  STARTING_MSG: toBool(process.env.STARTING_MSG) || true,
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'TroubleMaker┃ᴮᴼᵀ;Vivek;https://telegra.ph/file/238b8ea9aab7c77c30052.jpg',
